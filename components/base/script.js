...
components.fonts = {
	selector: 'html',
	styles: 'https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&family=Poppins:wght@400;500;600;700&display=swap'
};
	...
	init: function ( nodes ) {
		...
		nodes.forEach( function ( node ) {
			...
			if ( !window.xMode && !isMobile ) {
				...
				jnode.css({"background-image": 'url(' + jnode.data("parallax-img") + ')'})
			}
		});
	}
};
...
components.gmap = {
	...
	script: [
		'//maps.google.com/maps/api/js?libraries=geometry,places&v=quarterly',
